aPackageInfo = [
	...
	:files = 	[
		...
		"examples/05_invoke.ring",
		"examples/05_invoke.slint",
		"examples/06_globals.ring",
		"examples/06_globals.slint",
		"examples/07_timer.ring",
		"examples/07_timer.slint",
		"examples/08_temperature.ring",
		"examples/08_temperature.slint",
		"examples/09_todo.ring",
		"examples/09_todo.slint",
		"examples/10_stopwatch.ring",
		"examples/10_stopwatch.slint",
		"examples/11_calculator.ring",
		"examples/11_calculator.slint",
		"examples/12_custom_window.ring",
		"examples/12_custom_window.slint",
		"examples/13_fonts.ring",
		"examples/13_fonts.slint",
		"examples/14_file_dialogs.ring",
		"examples/14_file_dialogs.slint",
		"examples/15_loadstring.ring",
		"examples/16_window_management.ring",
